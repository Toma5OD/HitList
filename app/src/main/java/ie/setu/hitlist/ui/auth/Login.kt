...
import ie.setu.hitlist.databinding.LoginBinding
import ie.setu.hitlist.ui.home.Home
...
class Login : AppCompatActivity() {
    ...
    private fun validateForm(): Boolean {
        ...
        if (TextUtils.isEmpty(email)) {
            loginBinding.fieldEmail.error = "The Email Address is not provided."
            valid = false
        } else {
        ...
        if (TextUtils.isEmpty(password)) {
            loginBinding.fieldPassword.error = "The password is not provided."
            valid = false
        } else {
